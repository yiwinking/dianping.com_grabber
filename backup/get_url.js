...
//var url_from = "http://www.dianping.com/search/category/4/10/g363p2"
var url_from = phantom.args[0]
page.open(url_from,function(status){
    if(status == 'success'){
...
function get_elements_info(){
    ...
    //     var body_info = document.body.innerHTML;
	 var shop_url = document.getElementsByClassName("shopname");
...
//	if(cuisine_info[count].innerHTML == "标签:"){break;}
//	}
...
var s= new Array();
       ...
       for(var url_count = 0; url_count < shop_url.length; url_count++)
{
  s[url_count] = shop_url[url_count].innerHTML;
}
        return s;
    });
